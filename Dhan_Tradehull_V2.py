...
print("Codebase Version 2.6 : Solved - Pnl Issue")
	...
	def get_live_pnl(self):
		...
		try:
			...
			for pos_ in pos_book_dict:
				...
				underlying = instrument_df[((instrument_df['SEM_SMST_SECURITY_ID']==security_id))].iloc[-1]['SEM_TRADING_SYMBOL']
